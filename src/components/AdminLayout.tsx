    ...
    <div className="min-h-screen flex bg-background text-foreground">
      ...
      >
        <div className="h-16 flex items-center gap-2 px-5 border-b border-sidebar-border">
          ...
          <div>
            <div className="font-display font-bold text-lg text-sidebar-foreground leading-tight">
              LC-LAB
            </div>
          ...
          {visible.map((n) => {
            ...
            return (
              ...
              >
                ...
                {n.badge && count > 0 && (
                  <Badge className="bg-gold text-primary-foreground hover:bg-gold">{count}</Badge>
                )}
              </Link>
            );
          })}
